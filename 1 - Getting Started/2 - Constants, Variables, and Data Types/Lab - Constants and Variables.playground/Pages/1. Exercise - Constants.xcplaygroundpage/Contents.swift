...
print("No the above code doesn't compile and that is because friends is a constant and constants can't be updated or their values can't be changed , we use variables for that case.")
